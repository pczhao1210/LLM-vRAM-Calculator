...
- A100、H100、H200、RTX PRO 6000 Blackwell、GB200、GB300 的推荐逻辑
- 一个可直接运行的单页前端界面
...
4. 提交并推送 [.github/workflows/azure-static-web-apps.yml](/home/alex/Playground/LLM-vRAM-Calculator/.github/workflows/azure-static-web-apps.yml)。
...
项目已经包含 [app/public/staticwebapp.config.json](/home/alex/Playground/LLM-vRAM-Calculator/app/public/staticwebapp.config.json)，用于支持单页应用的路由回退，避免刷新子路由时出现 404。
...
- GB200 按 superchip 处理，GB300 按平台级方案展示，不与普通单卡混淆。
